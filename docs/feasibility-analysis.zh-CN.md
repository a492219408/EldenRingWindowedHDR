...
分析日期：2026-08-31  
实机目标：App Ver. 1.17 / `eldenring.exe` 2.7.0.0；兼容性静态对照：App Ver. 1.16.2
...
| --- | --- | ---: | --- | --- |
| 1.16.2 | 2.6.2.0 | 86,998,096 | `34102B1C08BB5F769A724427A6F70FE29B3B732C31CF73693F861C48D3492DDB` | 双版本静态解析通过；未实机加载本 MOD |
